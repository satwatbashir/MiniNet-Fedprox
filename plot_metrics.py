...
# ------------------------------ Wall-clock Time ------------------------------
ax_time = axes[1, 1]
if "total_comp_sec" in distributed_df.columns:
    ax_time.plot(distributed_df["round"], distributed_df["total_comp_sec"], label="Total Comp Time (s)")
...
ax_comp4 = axes4[1, 1]
if "total_comp_sec" in distributed_df.columns:
    ax_comp4.plot(distributed_df["round"], distributed_df["total_comp_sec"], label="Total Comp Time (s)")
